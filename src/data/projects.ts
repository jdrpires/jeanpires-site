...
export const projectCases: ProjectCase[] = [
  ...
  {
    slug: "no-diva",
    title: "No Divã Treinamentos",
    tagline: "Workflows digitais seguros para uma operação real.",
    description:
      "Plataforma de produção com inscrições em múltiplas etapas, documentos, backoffice, avaliação humana, controle de acesso e rastreabilidade operacional.",
    category: "Plataforma / Operações",
    status: "Produção",
    role: "Arquitetura · Engenharia · Entrega",
    stack: ["Next.js", "PostgreSQL", "Supabase", "RLS", "Security"],
    image: null,
    url: null,
